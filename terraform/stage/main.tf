...
locals {
  ...
  fe_image                             = "us-central1-docker.pkg.dev/structhub-412620/xtract/xtract-fe:gcr-236.0.0"
  indexer_image                        = "us-central1-docker.pkg.dev/structhub-412620/xtract/xtract-indexer:43.0.0"
