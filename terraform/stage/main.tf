...
locals {
  ...
  metadata_image                       = "us-central1-docker.pkg.dev/structhub-412620/xtract/metadata:13.0.0"
  fe_image                             = "us-central1-docker.pkg.dev/structhub-412620/xtract/xtract-fe:gcr-287.0.0"
  indexer_image                        = "us-central1-docker.pkg.dev/structhub-412620/xtract/xtract-indexer:88.0.0"
  websearch_image                      = "us-central1-docker.pkg.dev/structhub-412620/xtract/searxng:6.0.0"
  gdrive_image                         = "us-central1-docker.pkg.dev/structhub-412620/xtract/googledrive-indexer:41.0.0"
  confluence_image                     = "us-central1-docker.pkg.dev/structhub-412620/xtract/confluence-indexer-30.0.0"
  onedrive_image                       = "us-central1-docker.pkg.dev/structhub-412620/xtract/onedrive-indexer:22.0.0"
  sharepoint_image                     = "us-central1-docker.pkg.dev/structhub-412620/xtract/sharepoint-indexer:23.0.0"
  s3_image                             = "us-central1-docker.pkg.dev/structhub-412620/xtract/s3-indexer:31.0.0"
  azureblob_image                      = "us-central1-docker.pkg.dev/structhub-412620/xtract/azureblob-indexer:25.0.0"
  gcpbucket_image                      = "us-central1-docker.pkg.dev/structhub-412620/xtract/gcpbucket-indexer:31.0.0"
